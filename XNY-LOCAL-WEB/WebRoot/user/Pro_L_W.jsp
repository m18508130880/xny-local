	...
	<table width="100%" style='margin:auto;' border=0 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">
		...
		<tr height='30' valign='middle'>
			<td width='100%' align='center' colspan=2>
					...
					while(iterator.hasNext())
					{
						...
						if(!T_Cpm_Id.equals(Bean.getCpm_Id()))
						{
							if(T_Cpm_Id.length() > 0)
							{
								...
								String Summary = "1、本站在运营车辆共"+ Car_Cnt +"台;";
				%>
								<tr height='100'>
								  <td width='24%' align=center colspan=2><strong>本周生产情况小结</strong></td>
								  <td width='76%' align=left colspan=9 valign=top><%=Summary%></td>
								</tr>							
								<tr height='30'>
								  <td width='32%' align=center colspan=3><strong>制表: </strong>系统</td>
								  <td width='24%' align=center colspan=3><strong>审核: </strong><%=Operator_Name%></td>
								  <td width='44%' align=center colspan=5><strong>上报日期: </strong><%=CommUtil.getDate()%></td>
								</tr>
				<%
							}
				...
				%>
							<tr height='50'>
								<td width='100%' align=center colspan=11><font size=4><B>加气站生产运营周报表[<%=Oil_Name%>]</B></font></td>
							</tr>
							<tr height='30'>
								<td width='100%' align=center colspan=11>
									<table width="100%" border=0 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">
										<tr height='30'>
											...
											<td width='55%' align=left><strong>站点名称:中海油珠海新能源有限公司<%=T_Cpm_Name%>站</strong></td>
											<td width='35%' align=left><strong>数据日期: <%=BDate%> 至 <%=EDate%></strong></td>
										</tr>
									</table>
								</td>
							</tr>
							<tr height='30'>
						    <td width='24%' align=center rowspan='2' colspan=2><strong>项目\日期</strong></td>
						    <td width='8%'  align=center><strong>星期日</strong></td>
						    <td width='8%'  align=center><strong>星期一</strong></td>
						    <td width='8%'  align=center><strong>星期二</strong></td>
						    <td width='8%'  align=center><strong>星期三</strong></td>
						    <td width='8%'  align=center><strong>星期四</strong></td>
						    <td width='8%'  align=center><strong>星期五</strong></td>
						    <td width='8%'  align=center><strong>星期六</strong></td>
						    <td width='10%' align=center rowspan='2'><strong>本周累计</strong></td>
						    <td width='10%' align=center rowspan='2'><strong>本年累计</strong></td>
						  </tr>
						  <%
						  String Name1 = "";
						  String Name2 = "";
						  ...
						  <tr height='30'>
						    <td width='12%' align=center rowspan=2>销售数量</td>
						  ...
						  <tr height='30'>
						    <td width='12%' align=center rowspan=2>购入数量</td>
						    <td width='12%' align=center><%=Name1%></td>
						  ...
						  <tr height='30'>
						    <td width='12%' align=center rowspan=2>库存数量</td>
						    <td width='12%' align=center><%=Name1%></td>
				...
				<%
						...
						if(cnt == Pro_L_W.size())
						{
							...
							String Summary = "1.本站在运营车辆共"+ Car_Cnt +"台;";
							String Summshe = "2.本周销售量为：";
							String Summkuc ="3.本周结余库存量：";							
				%> 
							<tr height='100'>
								  <td width='24%' align=center colspan=2><strong>本周生产情况小结</strong></td>
				...
				%>
					<tr height='30'>
						<td width='100%' align=center colspan=11>无!</td>
					</tr>
				<%
				}
				%>
