...
<div id="down_bg_2">
	<table width="100%" style='margin:auto;' border=0 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">
		<tr height='25px' class='sjtop'>
	        ...
	        <option id='OP1' value="3" <%=(currStatus.getFunc_Sub_Id() == 3 ?"SELECTED":"")%>>公司月统计</option>
	        <option id='OP2' value="4" <%=(currStatus.getFunc_Sub_Id() == 4 ?"SELECTED":"")%>>公司年统计</option>
	      </select>
		...
		<tr height='30' valign='middle'>
			<td width='100%' align='center' colspan=2>
				...
				%>
							<tr height='50'>
								<td width='100%' align=center colspan=7><font size=4><B>加气站购销统计月报表[<%=Oil_Name%>]</B></font></td>
							</tr>
							<tr height='30'>
					...
					<table width='100%'  border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">
						    ...
						    <td width='300px' align=center ><strong>库存数量</strong></td>
						    <td width='300px' align=center ><strong>盈亏数量</strong></td>						    
		...
		<%		  
					...
					<table width='100%'  border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">							
							<tr height='30'>
							  ...
							  <td width='30%' align=center colspan=2><strong>审核: </strong><%=Operator_Name%></td>
