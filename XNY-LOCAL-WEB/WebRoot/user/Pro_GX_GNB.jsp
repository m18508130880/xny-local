		...
		<tr height='30' valign='middle'>
			<td width='100%' align='center' colspan=2>
				<table width="100%" border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">	
							...
							<tr height='50'>
								<td width='100%' align=center colspan=9><font size=4><B>公司购销统计年报表[<%=Oil_Name%>]</B></font></td>
							</tr>
							<tr height='30'>
					...
					<table width='100%'  border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">
						    ...
						    <td width='300px' align=center ><strong>运营亏损</strong></td>
						     <td width='300px' align=center ><strong>购入气量</strong></td>
						    <%
				...
				<%		  
					...
					<table width='100%'  border=1 cellPadding=0 cellSpacing=0 bordercolor="#3491D6" borderColorDark="#ffffff">		
							<tr height='30'>
							  ...
							  <td width='30%' align=center colspan=4><strong>上报日期: </strong>\</td>
							</tr>	
