				...
				%>
					<tr height='50'>
						<td width='100%' align=center colspan=9>
							<!--<font size=4><B><%=Corp_Name%>生产运营周报汇总表[<%=Oil_Name%>]</B></font>-->
							<font size=4><B>中海油珠海新能源有限公司生产周报运营表</B></font>
						</td>
					</tr>
					<tr height='30'>
						<td width='100%' align=right colspan=9>
							<strong>数据日期: <%=BDate%> 至 <%=EDate%></strong>
						</td>
					</tr>
					<tr height='30'>
					...
					<tr height='30'>
						...
						<td width='10%' align=center><strong>本周累计</strong></td>
